...
//		boolean ignoreMatching = true;
	...
	static void example1(){
		SxRuntimeSettings SXSettings = 
				new SoundExExpression.SxRuntimeSettings(SxSIMULARITY.GROUP_SAME,
							compareMethod.EXISTENCE,
							SoundExExpression.UF_IgnoredMatching.IGNORE,
							outputFormat  );
